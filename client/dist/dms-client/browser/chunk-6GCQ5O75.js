...
var x = class extends ie {
  ...
  B = class r extends x {
    ...
    getCookie(n) {
      return ae(document.cookie, n);
    }
  },
  T = null;
function Se() {
  return (
    (T = T || document.querySelector("base")), T ? T.getAttribute("href") : null
  );
}
function we(r) {
...
var Me = (() => {
    class r {
      ...
      static ɵprov = f({ token: r, factory: r.ɵfac });
    }
    return r;
  })(),
  F = new L(""),
...
function Te(r, n, e, t) {
  let o = r.head?.querySelectorAll(`style[${A}="${n}"],link[${A}="${n}"]`);
  if (o)
    for (let s of o)
      s.removeAttribute(A),
...
function $(r, n) {
  ...
  return e.setAttribute("rel", "stylesheet"), e.setAttribute("href", r), e;
}
var ge = (() => {
    class r {
      doc;
      ...
      constructor(e, t, o, s = {}) {
        (this.doc = e),
          ...
          (this.nonce = o),
          (this.isServer = j(s)),
          Te(e, t, this.inline, this.external),
          this.hosts.add(e.head);
      }
      addStyles(e, t) {
        for (let o of e) this.addUsage(o, this.inline, ue);
        t?.forEach((o) => this.addUsage(o, this.external, $));
      }
      removeStyles(e, t) {
      ...
      removeUsage(e, t) {
        let o = t.get(e);
        o && (o.usage--, o.usage <= 0 && (de(o.elements), t.delete(e)));
      }
      ngOnDestroy() {
      ...
      addHost(e) {
        ...
        for (let [t, { elements: o }] of this.inline)
          o.push(this.addElement(e, ue(t, this.doc)));
        for (let [t, { elements: o }] of this.external)
          o.push(this.addElement(e, $(t, this.doc)));
      }
      removeHost(e) {
        this.hosts.delete(e);
      }
      addElement(e, t) {
        return (
          ...
          this.isServer && t.setAttribute(A, this.appId),
          e.appendChild(t)
        );
      }
      static ɵfac = function (t) {
        return new (t || r)(c(p), c(N), c(P, 8), c(b));
      };
      static ɵprov = f({ token: r, factory: r.ɵfac });
    }
    return r;
...
var ve = "%COMP%",
  ...
  Re = `_ngcontent-${ve}`,
  Ce = !0,
  be = new L("", { providedIn: "root", factory: () => Ce });
function Ae(r) {
  return Re.replace(Z, r);
}
function _e(r) {
  return De.replace(Z, r);
}
function ye(r, n) {
  return n.map((e) => e.replace(Z, r));
}
var fe = (() => {
    class r {
      eventManager;
      ...
      defaultRenderer;
      platformIsServer;
      constructor(e, t, o, s, i, a, d, u = null, l = null) {
        (this.eventManager = e),
          ...
          (this.platformIsServer = j(a)),
          (this.defaultRenderer = new D(
            e,
            i,
            d,
      ...
      createRenderer(e, t) {
        ...
        this.platformIsServer &&
          t.encapsulation === w.ShadowDom &&
          (t = z(I({}, t), { encapsulation: w.Emulated }));
        let o = this.getOrCreateRenderer(e, t);
        return (
          o instanceof O ? o.applyToHost(e) : o instanceof R && o.applyStyles(),
          o
        );
      }
      getOrCreateRenderer(e, t) {
        ...
        if (!s) {
          ...
          switch (t.encapsulation) {
            case w.Emulated:
              s = new O(d, u, t, this.appId, l, i, a, m, h);
              break;
            case w.ShadowDom:
              return new V(d, u, e, t, i, a, this.nonce, m, h);
            default:
              s = new R(d, u, t, l, i, a, m, h);
              break;
          }
          o.set(t.id, s);
        }
  ...
  D = class {
    ...
    createElement(n, e) {
      return e
        ? this.doc.createElementNS(U[e] || e, n)
    ...
    appendChild(n, e) {
      (pe(n) ? n.content : n).appendChild(e);
    }
    insertBefore(n, e, t) {
      n && (pe(n) ? n.content : n).insertBefore(e, t);
    }
    removeChild(n, e) {
      e.remove();
    }
    ...
    setStyle(n, e, t, o) {
      o & (M.DashCase | M.Important)
        ? n.style.setProperty(e, t, o & M.Important ? "important" : "")
        : (n.style[e] = t);
    }
    removeStyle(n, e, t) {
      t & M.DashCase ? n.style.removeProperty(e) : (n.style[e] = "");
    }
    setProperty(n, e, t) {
      n != null && (n[e] = t);
    }
    ...
    listen(n, e, t, o) {
      if (
        typeof n == "string" &&
        ((n = k().getGlobalEventTarget(this.doc, n)), !n)
      )
      ...
      return (
        this.tracingService !== null &&
          ...
          (s = this.tracingService.wrapEventListener(n, e, s)),
        this.eventManager.addEventListener(n, e, s, o)
      );
    }
...
function pe(r) {
  return r.tagName === "TEMPLATE" && r.content !== void 0;
}
var V = class extends D {
    sharedStylesHost;
    hostEl;
    shadowRoot;
    constructor(n, e, t, o, s, i, a, d, u) {
      super(n, s, i, d, u),
      ...
      for (let h of l) {
        ...
        a && v.setAttribute("nonce", a),
          (v.textContent = h),
          this.shadowRoot.appendChild(v);
      }
      let m = o.getExternalStyles?.();
      if (m)
        for (let h of m) {
          let v = $(h, s);
          a && v.setAttribute("nonce", a), this.shadowRoot.appendChild(v);
        }
    }
    nodeOrShadowRoot(n) {
  ...
  R = class extends D {
    ...
    constructor(n, e, t, o, s, i, a, d, u) {
      ...
      let l = t.styles;
      (this.styles = u ? ye(u, l) : l),
        (this.styleUrls = t.getExternalStyles?.(u));
    }
    applyStyles() {
  ...
  O = class extends R {
    ...
    constructor(n, e, t, o, s, i, a, d, u) {
      let l = o + "-" + t.id;
      super(n, e, t, s, i, a, d, u, l),
        (this.contentAttr = Ae(l)),
        (this.hostAttr = _e(l));
    }
    applyToHost(n) {
  ...
  He = (() => {
    class r extends _ {
      ...
      supports(e) {
        return r.parseEventName(e) != null;
      }
      addEventListener(e, t, o, s) {
        let i = r.parseEventName(t),
          a = r.eventCallback(i.fullKey, o, this.manager.getZone());
        return this.manager
          .getZone()
          .runOutsideAngular(() => k().onAndCancel(e, i.domEventName, a, s));
      }
      static parseEventName(e) {
        let t = e.toLowerCase().split("."),
          o = t.shift();
        if (t.length === 0 || !(o === "keydown" || o === "keyup")) return null;
        let s = r._normalizeKey(t.pop()),
          i = "",
          a = t.indexOf("code");
        if (
          ...
          return null;
        let d = {};
        return (d.domEventName = o), (d.fullKey = i), d;
      }
      static matchEventFullKeyCode(e, t) {
        let o = Ie[e.key] || e.key,
          s = "";
        return (
      ...
      static eventCallback(e, t, o) {
        return (s) => {
          r.matchEventFullKeyCode(s, e) && o.runGuarded(() => t(s));
        };
      }
...
function St(r, n) {
  return oe(I({ rootComponent: r }, Ne(n)));
}
function Ne(r) {
  return {
    appProviders: [...xe, ...(r?.providers ?? [])],
    platformProviders: Ue,
  };
}
function Pe() {
  B.makeCurrent();
...
function je() {
  return Y(document), document;
}
var Ue = [
  { provide: b, useValue: ce },
  { provide: W, useValue: Pe, multi: !0 },
  { provide: p, useFactory: je, deps: [] },
];
var xe = [
  { provide: G, useValue: "root" },
  { provide: H, useFactory: ke, deps: [] },
  { provide: F, useClass: Oe, multi: !0, deps: [p] },
  { provide: F, useClass: He, multi: !0, deps: [p] },
  fe,
  ge,
  me,
  { provide: re, useExisting: fe },
  { provide: le, useClass: Me, deps: [] },
  [],
];
var wt = (() => {
  class r {
      ...
      sanitize(e, t) {
        ...
        switch (e) {
          case g.NONE:
            return t;
          case g.HTML:
            return S(t, "HTML") ? E(t) : ne(this._doc, String(t)).toString();
          case g.STYLE:
          ...
          case g.SCRIPT:
            ...
            throw new y(5200, !1);
          case g.URL:
            return S(t, "URL") ? E(t) : te(String(t));
          case g.RESOURCE_URL:
...
export { fe as a, St as b, wt as c, Be as d };
