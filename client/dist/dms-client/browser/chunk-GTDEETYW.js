import { d as ct } from "./chunk-6GCQ5O75.js";
import {
  $a as r,
  Bb as p,
  Ca as w,
...
var y = (function (s) {
  ...
  Pt = "*";
function dt(s, i) {
  return { type: y.Trigger, name: s, definitions: i, options: {} };
}
function Q(s, i = null) {
  return { type: y.Animate, styles: i, timings: s };
}
function Bt(s, i = null) {
  return { type: y.Sequence, steps: s, options: i };
}
function N(s) {
  return { type: y.Style, styles: s, offset: null };
}
function M(s, i, t) {
  return { type: y.State, name: s, styles: i, options: t };
}
function Y(s, i, t = null) {
  return { type: y.Transition, expr: s, animation: i, options: t };
}
var ut = class {
    _onDoneFns = [];
    _onStartFns = [];
    ...
    triggerCallback(i) {
      let t = i == "start" ? this._onStartFns : this._onDoneFns;
  ...
  ht = class {
    ...
    setPosition(i) {
      let t = i * this.totalTime;
      this.players.forEach((e) => {
        let n = e.totalTime ? Math.min(1, t / e.totalTime) : 1;
        e.setPosition(n);
      });
    }
    getPosition() {
      let i = this.players.reduce(
        (t, e) => (t === null || e.totalTime > t.totalTime ? e : t),
        null,
      );
      return i != null ? i.getPosition() : 0;
    }
    beforeDestroy() {
...
function Ct(s, i) {
  if ((s & 1 && (z(0), f(1), $()), s & 2)) {
    let t = c(2);
    r(), g("[", t.duplicatesCount + 1, "]");
  }
}
function bt(s, i) {
  if (
    (s & 1 && (h(0, "div"), f(1), x(2, Ct, 2, 1, "ng-container", 4), m()),
    s & 2)
  ) {
    let t = c();
    p(t.options.titleClass),
      O("aria-label", t.title),
      r(),
      g(" ", t.title, " "),
      r(),
      l("ngIf", t.duplicatesCount);
  }
}
function Dt(s, i) {
  if ((s & 1 && E(0, "div", 7), s & 2)) {
    let t = c();
    p(t.options.messageClass), l("innerHTML", t.message, Z);
  }
}
function It(s, i) {
  if ((s & 1 && (h(0, "div", 8), f(1), m()), s & 2)) {
    let t = c();
    p(t.options.messageClass),
      O("aria-label", t.message),
      r(),
      g(" ", t.message, " ");
  }
}
function wt(s, i) {
  if ((s & 1 && (h(0, "div"), E(1, "div", 9), m()), s & 2)) {
    let t = c();
    r(), S("width", t.width() + "%");
  }
}
...
function St(s, i) {
  if (
    (s & 1 && (h(0, "div"), f(1), x(2, Ot, 2, 1, "ng-container", 4), m()),
    s & 2)
  ) {
    let t = c();
    p(t.options.titleClass),
...
var J = class {
    ...
    injector;
    constructor(i, t) {
      (this.component = i), (this.injector = t);
    }
    attach(i, t) {
      return (this._attachedHost = i), i.attach(this, t);
    }
    detach() {
  ...
  W = class {
    ...
    _disposeFn;
    attach(i, t) {
      return (this._attachedPortal = i), this.attachComponentPortal(i, t);
    }
    detach() {
  ...
  X = class {
    ...
    onDuplicate(i, t) {
      i && this._resetTimeout.next(),
        t && this._countDuplicate.next(++this.duplicatesCount);
    }
  },
  D = class {
    toastId;
  ...
  tt = class extends W {
    ...
    attachComponentPortal(i, t) {
      let e = this._componentFactoryResolver.resolveComponentFactory(
          i.component,
        ),
        n;
      return (
        (n = e.create(i.injector)),
  ...
  et = class {
    ...
    attach(i, t = !0) {
      return this._portalHost.attach(i, t);
    }
    detach() {
  ...
  Ht = (() => {
    class s {
      _overlayContainer = b(At);
      _componentFactoryResolver = b(at);
      _appRef = b(j);
      _document = b(U);
      ...
      _createPortalHost(t) {
        return new tt(t, this._componentFactoryResolver, this._appRef);
      }
      _createOverlayRef(t) {
        return new et(this._createPortalHost(t));
      }
      static ɵfac = function (e) {
        return new (e || s)();
      };
    ...
    class s {
      ...
      constructor(t, e, n, o, a) {
        (this.overlay = e),
          ...
          (this.sanitizer = o),
          (this.ngZone = a),
          (this.toastrConfig = u(u({}, t.default), t.config)),
          t.config.iconClasses &&
            (this.toastrConfig.iconClasses = u(
              u({}, t.default.iconClasses),
              t.config.iconClasses,
            ));
      }
      show(t, e, n = {}, o = "") {
        return this._preBuildNotification(o, t, e, this.applyConfig(n));
      }
      success(t, e, n = {}) {
      ...
      clear(t) {
        for (let e of this.toasts)
          if (t !== void 0) {
            if (e.toastId === t) {
              e.toastRef.manualClose();
              return;
            }
          } else e.toastRef.manualClose();
      }
      remove(t) {
        let e = this._findToast(t);
        if (
          !e ||
      ...
      findDuplicate(t = "", e = "", n, o) {
        let { includeTitleDuplicates: a } = this.toastrConfig;
        for (let d of this.toasts) {
          let R = a && d.title === t;
          if ((!a || R) && d.message === e)
            return d.toastRef.onDuplicate(n, o), d;
        }
        return null;
      }
      applyConfig(t = {}) {
        return u(u({}, this.toastrConfig), t);
      }
      _findToast(t) {
      ...
      _preBuildNotification(t, e, n, o) {
        return o.onActivateTick
          ? this.ngZone.run(() => this._buildNotification(t, e, n, o))
          : this._buildNotification(t, e, n, o);
      }
      _buildNotification(t, e, n, o) {
        ...
        if (
          ((this.toastrConfig.includeTitleDuplicates && n) || e) &&
        ...
        let R = this.overlay.create(o.positionClass, this.overlayContainer);
        this.index = this.index + 1;
        let it = e;
        e && o.enableHtml && (it = this.sanitizer.sanitize(rt.HTML, e));
        let I = new X(R),
          P = new D(this.index, o, it, n, t, I),
          vt = [{ provide: D, useValue: P }],
          gt = H.create({ providers: vt, parent: this._injector }),
          yt = new J(o.toastComponent, gt),
          st = R.attach(yt, o.newestOnTop);
        I.componentInstance = st.instance;
        let B = {
          toastId: this.index,
          title: n || "",
          message: e || "",
          toastRef: I,
          onShown: I.afterActivate(),
          onHidden: I.afterClosed(),
          onTap: P.onTap(),
          onAction: P.onAction(),
          portal: st,
        };
      ...
      static ɵfac = function (e) {
        return new (e || s)(C(ft), C(Ht), C(H), C(ct), C(L));
      };
      static ɵprov = A({ token: s, factory: s.ɵfac, providedIn: "root" });
    }
    return s;
    ...
    class s {
      ...
      constructor(t, e, n) {
        (this.toastrService = t),
          ...
          (this.sub3 = e.toastRef.countDuplicate().subscribe((o) => {
      ...
      activateToast() {
        this.state.update((t) => T(u({}, t), { value: "active" })),
          !(
      ...
      updateProgress() {
        ...
        let t = new Date().getTime(),
          e = this.hideTime - t;
        this.width.set((e / this.options.timeOut) * 100),
      ...
      remove() {
        this.state().value !== "removed" &&
          (clearTimeout(this.timeout),
          this.state.update((t) => T(u({}, t), { value: "removed" })),
          this.outsideTimeout(
      ...
      outsideTimeout(t, e) {
        this.ngZone
          ? this.ngZone.runOutsideAngular(
              () =>
                (this.timeout = setTimeout(() => this.runInsideAngular(t), e)),
            )
      ...
      static ɵcmp = q({
        ...
        hostBindings: function (e, n) {
          e & 1 &&
            ...
            e & 2 &&
              (lt("@flyInOut", n._state),
              p(n.toastClasses),
              S("display", n.displayStyle));
        },
        attrs: pt,
        decls: 5,
        vars: 5,
        ...
        template: function (e, n) {
          e & 1 &&
            x(0, Tt, 3, 0, "button", 0)(1, bt, 3, 5, "div", 1)(
              2,
              Dt,
              1,
              3,
              "div",
              2,
            )(3, It, 2, 4, "div", 3)(4, wt, 2, 2, "div", 4),
            e & 2 &&
              (l("ngIf", n.options.closeButton),
              r(),
              l("ngIf", n.title),
              r(),
              l("ngIf", n.message && n.options.enableHtml),
              r(),
              l("ngIf", n.message && !n.options.enableHtml),
              r(),
              l("ngIf", n.options.progressBar));
        },
        dependencies: [K],
        encapsulation: 2,
        data: {
          animation: [
            dt("flyInOut", [
              M("inactive", N({ opacity: 0 })),
              M("active", N({ opacity: 1 })),
              M("removed", N({ opacity: 0 })),
              Y("inactive => active", Q("{{ easeTime }}ms {{ easing }}")),
              Y("active => removed", Q("{{ easeTime }}ms {{ easing }}")),
            ]),
          ],
        },
        changeDetection: 0,
  ...
  Nt = T(u({}, mt), { toastComponent: jt }),
  oe = (s = {}) => ot([{ provide: ft, useValue: { default: Nt, config: s } }]);
var Mt = (() => {
    class s {
      toastrService;
      toastPackage;
      ...
      static ɵcmp = q({
        ...
        hostBindings: function (e, n) {
          e & 1 &&
            ...
            e & 2 && (p(n.toastClasses), S("display", n.displayStyle));
        },
        attrs: pt,
        decls: 5,
        vars: 5,
        ...
        template: function (e, n) {
          e & 1 &&
            x(0, xt, 3, 0, "button", 0)(1, St, 3, 5, "div", 1)(
              2,
              Et,
              1,
              3,
