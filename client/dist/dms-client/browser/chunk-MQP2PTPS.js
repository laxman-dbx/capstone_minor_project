import { b as O, e as I, h as S, q as E } from "./chunk-ZOHBZ4HP.js";
import { a as L } from "./chunk-UD6YS3BW.js";
import { c as w } from "./chunk-6FEKEJIW.js";
import {
  $a as r,
  $b as f,
  Ab as C,
...
var z = class e {
  ...
  maskText() {
    ...
    (this.isLoading = !0),
      (this.errorMessage = ""),
      this.http
        .post(`${L.apiUrl}/api/users/replace-chars`, { text: this.inputText })
        .subscribe({
          next: (o) => {
  ...
  static ɵcmp = M({
    ...
    template: function (d, t) {
      d & 1 &&
        ...
        n()()()(),
        g(27, F, 3, 1, "div", 19)(28, V, 3, 0, "div", 20),
        n()),
        d & 2 &&
          (r(9),
