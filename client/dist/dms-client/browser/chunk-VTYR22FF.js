import { a as le } from "./chunk-5QNQV3N7.js";
import { a as ue } from "./chunk-UD6YS3BW.js";
import { ca as he, d as We, ha as fe, p as ce } from "./chunk-4KGF3EVT.js";
...
var me =
  ...
  B = ({ type: r, data: e }, t, s) =>
    me && e instanceof Blob
      ? t
        ? s(e)
        : pe(e, s)
      : ye && (e instanceof ArrayBuffer || ge(e))
        ? t
          ? s(e)
          : pe(new Blob([e]), s)
        : s(d[r] + (e || "")),
...
var X;
function _e(r, e) {
  if (me && r.data instanceof Blob)
    return r.data.arrayBuffer().then(de).then(e);
  if (ye && (r.data instanceof ArrayBuffer || ge(r.data))) return e(de(r.data));
  B(r, !1, (t) => {
...
for (let r = 0; r < be.length; r++) N[be.charCodeAt(r)] = r;
var we = (r) => {
  let e = r.length * 0.75,
    t = r.length,
    s,
  ...
  let m = new ArrayBuffer(e),
    p = new Uint8Array(m);
  for (s = 0; s < t; s += 4)
    (n = N[r.charCodeAt(s)]),
      (o = N[r.charCodeAt(s + 1)]),
      (c = N[r.charCodeAt(s + 2)]),
      (h = N[r.charCodeAt(s + 3)]),
      (p[i++] = (n << 2) | (o >> 4)),
      (p[i++] = ((o & 15) << 4) | (c >> 2)),
      (p[i++] = ((c & 3) << 6) | (h & 63));
  return m;
...
var Ke = typeof ArrayBuffer == "function",
  L = (r, e) => {
    if (typeof r != "string") return { type: "message", data: ke(r, e) };
    let t = r.charAt(0);
    return t === "b"
      ? { type: "message", data: Ye(r.substring(1), e) }
      : C[t]
        ? r.length > 1
          ? { type: C[t], data: r.substring(1) }
          : { type: C[t] }
        : O;
  },
  Ye = (r, e) => {
...
var ve = "",
  ...
  xe = (r, e) => {
    ...
    for (let i = 0; i < t.length; i++) {
      let n = L(t[i], e);
      if ((s.push(n), n.type === "error")) break;
    }
    return s;
  };
function Te() {
...
function M(r, e) {
  ...
  let t = new Uint8Array(e),
    s = 0;
  for (let i = 0; i < e; i++)
    (t[i] = r[0][s++]), s === r[0].length && (r.shift(), (s = 0));
    ...
    transform(o, c) {
      for (t.push(o); ; ) {
        if (s === 0) {
          ...
          (i = p * Math.pow(2, 32) + m.getUint32(4)), (s = 3);
        } else {
          if (F(t) < i) break;
          let h = M(t, i);
          c.enqueue(L(n ? h : $.decode(h), e)), (s = 0);
        }
        if (i === 0 || i > r) {
          c.enqueue(O);
          break;
...
function Je(r) {
  for (var e in f.prototype) r[e] = f.prototype[e];
  return r;
}
f.prototype.on = f.prototype.addEventListener = function (r, e) {
  return (
...
f.prototype.listeners = function (r) {
  return (
    (this._callbacks = this._callbacks || {}), this._callbacks["$" + r] || []
  );
};
f.prototype.hasListeners = function (r) {
...
function g(r, e) {
  e.useNativeTimers
    ? ((r.setTimeoutFn = ze.bind(u)), (r.clearTimeoutFn = Xe.bind(u)))
    : ((r.setTimeoutFn = u.setTimeout.bind(u)),
      (r.clearTimeoutFn = u.clearTimeout.bind(u)));
}
var $e = 1.33;
function Se(r) {
  return typeof r == "string"
    ? Qe(r)
    : Math.ceil((r.byteLength || r.size) * $e);
}
function Qe(r) {
  let e = 0,
    t = 0;
...
var W = class extends Error {
  ...
  _ = class extends f {
    ...
    onError(e, t, s) {
      return super.emitReserved("error", new W(e, t, s)), this;
    }
    open() {
    ...
    onData(e) {
      let t = L(e, this.socket.binaryType);
      this.onPacket(t);
    }
    onPacket(e) {
...
var P = class extends _ {
  ...
  uri() {
    let e = this.opts.secure ? "https" : "http",
      t = this.query || {};
    return (
      this.opts.timestampRequests !== !1 && (t[this.opts.timestampParam] = H()),
...
var j = class extends P {
    ...
    doWrite(e, t) {
      let s = this.request({ method: "POST", data: e });
      s.on("success", t),
        s.on("error", (i, n) => {
  ...
  K = (() => {
    class r extends f {
      ...
      _create() {
        ...
        let i = (this._xhr = this.createRequest(s));
        try {
            ...
            if (this._opts.extraHeaders) {
              ...
              for (let n in this._opts.extraHeaders)
                this._opts.extraHeaders.hasOwnProperty(n) &&
                  i.setRequestHeader(n, this._opts.extraHeaders[n]);
            }
          } catch {}
            ...
            (i.onreadystatechange = () => {
              ...
              i.readyState === 3 &&
                ((n = this._opts.cookieJar) === null ||
                  n === void 0 ||
                  n.parseCookies(i.getResponseHeader("set-cookie"))),
                i.readyState === 4 &&
        ...
        typeof document < "u" &&
          ((this._index = r.requestsCount++), (r.requests[this._index] = this));
      }
      _onError(t) {
      ...
      _cleanup(t) {
        if (!(typeof this._xhr > "u" || this._xhr === null)) {
          if (((this._xhr.onreadystatechange = je), t))
            try {
              this._xhr.abort();
            } catch {}
          typeof document < "u" && delete r.requests[this._index],
            (this._xhr = null);
        }
      }
      _onLoad() {
...
if (typeof document < "u") {
  if (typeof attachEvent == "function") attachEvent("onunload", Le);
    ...
    let r = "onpagehide" in u ? "pagehide" : "unload";
    addEventListener(r, Le, !1);
  }
}
function Le() {
  for (let r in K.requests)
    K.requests.hasOwnProperty(r) && K.requests[r].abort();
}
var Ge = (function () {
    let r = Pe({ xdomain: !1 });
  ...
  w = class extends j {
    constructor(e) {
      ...
      this.supportsBinary = Ge && !t;
    }
    request(e = {}) {
      return (
        Object.assign(e, { xd: this.xd }, this.opts), new K(Pe, this.uri(), e)
      );
    }
  };
function Pe(r) {
  let e = r.xdomain;
  try {
    if (typeof XMLHttpRequest < "u" && (!e || Ne)) return new XMLHttpRequest();
  } catch {}
  if (!e)
    try {
  ...
  Z = class extends _ {
    ...
    uri() {
      let e = this.opts.secure ? "wss" : "ws",
        t = this.query || {};
      return (
        this.opts.timestampRequests && (t[this.opts.timestampParam] = H()),
        this.supportsBinary || (t.b64 = 1),
        this.createUri(e, t)
      );
    }
  },
  G = u.WebSocket || u.MozWebSocket,
  k = class extends Z {
    createSocket(e, t, s) {
      return qe ? new G(e, t, s) : t ? new G(e, t) : new G(e);
    }
    doWrite(e, t) {
      this.ws.send(t);
    }
    ...
    this._transport.closed
      ...
      this._transport.ready.then(() => {
        this._transport.createBidirectionalStream().then((e) => {
          let t = Ae(Number.MAX_SAFE_INTEGER, this.socket.binaryType),
...
var ee = { websocket: k, webtransport: E, polling: w };
var Ze =
  ...
  return (
    t != -1 &&
      ...
      (n.authority = n.authority
        ...
        .replace(/;/g, ":")),
      (n.ipv6uri = !0)),
    (n.pathNames = tt(n, n.path)),
    (n.queryKey = st(n, n.query)),
    n
  );
}
function tt(r, e) {
...
var J = (() => {
    class r extends f {
      constructor(t, s) {
        ...
        } else s.host && (s.hostname = x(s.host).host);
        g(this, s),
          (this.secure =
            s.secure != null
              ? s.secure
          ...
          typeof this.opts.query == "string" &&
            (this.opts.query = Oe(this.opts.query)),
          te &&
            ...
            this.hostname !== "localhost" &&
              ...
              Y.push(this._offlineEventListener))),
          this.opts.withCredentials && (this._cookieJar = void 0),
          this._open();
      }
      createTransport(t) {
        let s = Object.assign({}, this.opts.query);
        (s.EIO = Q), (s.transport = t), this.id && (s.sid = this.id);
        let i = Object.assign(
          {},
          this.opts,
          {
      ...
      _getWritablePackets() {
        ...
        for (let i = 0; i < this.writeBuffer.length; i++) {
          let n = this.writeBuffer[i].data;
          if ((n && (s += Se(n)), i > 0 && s > this._maxPayload))
      ...
      _onClose(t, s) {
        if (
          ...
          if (
            ...
            let i = Y.indexOf(this._offlineEventListener);
            i !== -1 && Y.splice(i, 1);
          }
          (this.readyState = "closed"),
            (this.id = null),
            ...
            if (!s)
              if (b.type === "pong" && b.data === "probe") {
                if (
                  ...
                  return;
                (J.priorWebsocketSuccess = t.name === "websocket"),
...
function De(r, e = "", t) {
  ...
  (t = t || (typeof location < "u" && location)),
    ...
    (s.path = s.path || "/");
  let n = s.host.indexOf(":") !== -1 ? "[" + s.host + "]" : s.host;
  return (
    (s.id = s.protocol + "://" + n + ":" + s.port + e),
    (s.href =
      s.protocol + "://" + n + (t && t.port === s.port ? "" : ":" + s.port)),
    s
  );
}
var ae = {};
...
function D(r) {
  return (
    (it && (r instanceof ArrayBuffer || nt(r))) ||
    (ot && r instanceof Blob) ||
    (at && r instanceof File)
  );
}
function q(r, e) {
  if (!r || typeof r != "object") return !1;
  if (Array.isArray(r)) {
    for (let t = 0, s = r.length; t < s; t++) if (q(r[t])) return !0;
    return !1;
  }
  if (D(r)) return !0;
...
function Ie(r) {
  let e = [],
    ...
    s = r;
  return (
    (s.data = se(t, e)), (s.attachments = e.length), { packet: s, buffers: e }
  );
}
function se(r, e) {
  if (!r) return r;
  if (D(r)) {
    ...
    for (let s = 0; s < r.length; s++) t[s] = se(r[s], e);
    return t;
  } else if (typeof r == "object" && !(r instanceof Date)) {
    let t = {};
    for (let s in r)
      Object.prototype.hasOwnProperty.call(r, s) && (t[s] = se(r[s], e));
    return t;
  }
  return r;
}
function Fe(r, e) {
  return (r.data = re(r.data, e)), delete r.attachments, r;
}
function re(r, e) {
  if (!r) return r;
  if (r && r._placeholder === !0) {
    ...
    for (let t = 0; t < r.length; t++) r[t] = re(r[t], e);
  else if (typeof r == "object")
    for (let t in r)
      Object.prototype.hasOwnProperty.call(r, t) && (r[t] = re(r[t], e));
  return r;
}
var ct = [
    "connect",
  ...
  ie = class {
    ...
    encode(e) {
      return (e.type === a.EVENT || e.type === a.ACK) && q(e)
        ? this.encodeAsBinary({
...
var ne = class r extends f {
    ...
    decodeString(e) {
      ...
      if (e.charAt(++t)) {
        let n = this.tryParse(e.substr(t));
        if (r.isPayloadValid(s.type, n)) s.data = n;
    ...
    static isPayloadValid(e, t) {
      switch (e) {
        ...
        case a.CONNECT_ERROR:
          return typeof t == "string" || Me(t);
        case a.EVENT:
        case a.BINARY_EVENT:
          return (
            Array.isArray(t) &&
            (typeof t[0] == "number" ||
              (typeof t[0] == "string" && ct.indexOf(t[0]) === -1))
          );
        case a.ACK:
        case a.BINARY_ACK:
  ...
  oe = class {
    ...
    takeBinaryData(e) {
      if (
        ...
        let t = Fe(this.reconPack, this.buffers);
  ...
  A = class extends f {
    ...
    emit(e, ...t) {
      ...
      if (
        ...
        let p = this.ids++,
          b = t.pop();
        this._registerAckCallback(p, b), (o.id = p);
      }
      let c =
          (i =
    ...
    _registerAckCallback(e, t) {
      ...
      let n = this.io.setTimeoutFn(() => {
        ...
        o = (...c) => {
          this.io.clearTimeoutFn(n), t.apply(this, c);
        };
    ...
    notifyOutgoingListeners(e) {
      if (this._anyOutgoingListeners && this._anyOutgoingListeners.length) {
        ...
        for (let s of t) s.apply(this, e.data);
      }
    }
  };
function v(r) {
...
v.prototype.setMin = function (r) {
  this.ms = r;
};
v.prototype.setMax = function (r) {
  this.max = r;
};
v.prototype.setJitter = function (r) {
  this.jitter = r;
};
var R = class extends f {
  ...
  open(e) {
    ...
    this.engine = new T(this.uri, this.opts);
    let t = this.engine,
      s = this;
    (this._readyState = "opening"), (this.skipReconnect = !1);
    let i = l(t, "open", function () {
        s.onopen(), e && e();
      }),
      n = (c) => {
        this.cleanup(),
  ...
  socket(e, t) {
    ...
    return (
      s
        ...
        : ((s = new A(this, e, t)), (this.nsps[e] = s)),
      s
    );
  }
  _destroy(e) {
    let t = Object.keys(this.nsps);
    for (let s of t) if (this.nsps[s].active) return;
    this._close();
  }
  _packet(e) {
...
function I(r, e) {
  ...
  let t = De(r, e.path || "/socket.io"),
    ...
    h;
  return (
    c ? (h = new R(s, e)) : (U[i] || (U[i] = new R(s, e)), (h = U[i])),
    t.query && !e.query && (e.query = t.queryKey),
    h.socket(t.path, e)
  );
}
Object.assign(I, { Manager: R, Socket: A, io: I, connect: I });
var He = class r {
  constructor(e) {
    this.authService = e;
  }
  ...
  connect() {
    ...
    (this.socket = I(ue.apiUrl, { auth: { token: e } })),
  ...
  joinChat(e) {
    this._messages.next(e.messages),
      this.socket.on(`chatMessage_${e._id}`, (t) => {
        let s = this._messages.getValue();
        this._messages.next([...s, t]);
      });
  }
  leaveChat(e) {
    this.socket.off(`chatMessage_${e}`);
  }
  sendMessage(e, t) {
    this.socket.emit("sendMessage", { ticketId: e, message: t }, (s) => {
      s.error
  ...
  static ɵfac = function (t) {
    return new (t || r)(fe(le));
  };
  static ɵprov = he({ token: r, factory: r.ɵfac, providedIn: "root" });
};
export { He as a };
