import { a as fn } from "./chunk-G4I7KY6Q.js";
...
import { d as tn } from "./chunk-OMR3M7LI.js";
import {
  $a as M,
  Aa as Vt,
  Ab as Oe,
...
var _n = "",
  gt = class {
    ...
    build(e, t, n) {
      let i = new yt(t);
      return this._resetContextStyleTimingState(i), q(this, Se(e), i);
    }
    ...
    visitKeyframes(e, t) {
      ...
      let u = e.steps.length,
        S = 0;
      s > 0 && s < u ? t.errors.push(ai()) : s == 0 && (S = i / (u - 1));
      let v = u - 1,
        p = t.currentTime,
    ...
    visitReference(e, t) {
      return {
        type: E.Reference,
        animation: q(this, Se(e.animation), t),
        options: se(e.options),
      };
    }
...
function bn(r, e, t, n, i, s, o, a, l, c, d, u, S) {
  return {
    type: 0,
    element: r,
    triggerName: e,
...
var lt = {},
  Ue = class {
    ...
    build(e, t, n, i, s, o, a, l, c, d) {
      let u = [],
        S = (this.ast.options && this.ast.options.params) || lt,
        v = (a && a.params) || lt,
        ...
        x = new Map(),
        D = i === "void",
        ce = { params: Ln(_, S), delay: this.ast.options?.delay },
      ...
      return (
        ...
        u.length
          ? bn(t, this._triggerName, n, i, D, p, C, [], [], k, x, R, u)
          : (U.forEach((F) => {
              let ee = F.element,
                ue = K(k, ee, new Set());
  ...
  constructor(e, t, n) {
    (this.name = e),
      ...
      t.states.forEach((i) => {
        ...
        this.states.set(i.name, new St(i.style, s, n));
      }),
      Sn(this.states, "true", "1"),
      Sn(this.states, "false", "0"),
...
var er = new Te(),
        ...
        (s
          ? ((o = Rn(
            ...
            o.forEach((d) => {
              ...
              d.postStyleProps.forEach((S) => u.set(S, null));
            }))
          : (i.push(hi()), (o = [])),
        i.length)
      )
  ...
  Tt = class {
    ...
    trigger(e, t, n, i = !0) {
      ...
      let S = K(this._engine.playersByElement, e, []);
      S.forEach((_) => {
  ...
  Ct = class {
    ...
    _flushAnimations(e, t) {
      ...
      let u = this.bodyNode,
        ...
        v = Cn(S, this.collectedEnterElements),
        p = new Map(),
        _ = 0;
      v.forEach((f, h) => {
        let y = On + _++;
...
function Tn(r, e, t, n, i) {
  ...
  n.forEach((l, c) => {
    let d = new Map();
    l.forEach((u) => {
      let S = e.computeStyle(c, u, i);
      d.set(u, S), (!S || S.length == 0) && ((c[j] = or), o.push(c));
    }),
      r.set(c, d);
  });
  let a = 0;
...
var Kn = [
    { provide: le, useFactory: br },
    { provide: ve, useClass: vr },
    { provide: Qt, useFactory: Sr, deps: [nn, ve, Bt] },
  ],
  Er = [
...
var Vn = [
  {
    path: "",
    loadComponent: () =>
      import("./chunk-HP4YOR6T.js").then((r) => r.HomeComponent),
  },
  {
    path: "sign-in",
    loadComponent: () =>
      import("./chunk-FJHZVE2X.js").then((r) => r.SignInComponent),
  },
  {
    path: "sign-up",
    loadComponent: () =>
      import("./chunk-F23T3LVZ.js").then((r) => r.SignUpComponent),
  },
  {
    path: "dashboard",
    loadComponent: () =>
      import("./chunk-FIC53XBS.js").then((r) => r.DashboardComponent),
  },
  {
    path: "upload",
    loadComponent: () =>
      import("./chunk-4VEIZXGD.js").then((r) => r.UploadComponent),
  },
  {
    path: "faq",
    loadComponent: () =>
      import("./chunk-VVLY5XHW.js").then((r) => r.FaqComponent),
  },
  {
    path: "error/:id",
    loadComponent: () =>
      import("./chunk-CQAXMCL3.js").then((r) => r.ErrorComponent),
  },
  {
    path: "profile",
    loadComponent: () =>
      import("./chunk-7D3RWK6D.js").then((r) => r.ProfileComponent),
  },
  {
    path: "mask-text",
    loadComponent: () =>
      import("./chunk-DK2A7XLG.js").then((r) => r.MaskTextComponent),
  },
  {
    path: "admin",
    loadComponent: () =>
      import("./chunk-3YQSOQ5O.js").then((r) => r.AdminDashboardComponent),
  },
  {
    path: "admin/login",
    loadComponent: () =>
      import("./chunk-NS2XO7YI.js").then((r) => r.AdminLoginComponent),
  },
  {
    path: "support",
    loadComponent: () =>
      import("./chunk-KAGXJ2QG.js").then((r) => r.SupportTicketComponent),
  },
  {
    path: "encrypt-text",
    loadComponent: () =>
      import("./chunk-A55KTNSI.js").then((r) => r.EncryptTextComponent),
  },
  {
    path: "decrypt-text",
    loadComponent: () =>
      import("./chunk-CBJ7NNI4.js").then((r) => r.DecryptTextComponent),
  },
  {
    path: "guide",
    loadComponent: () =>
      import("./chunk-EYGC535T.js").then((r) => r.GuideComponent),
  },
];
...
function Mr(r, e) {
  if ((r & 1 && (m(0, "span", 28), b(1), g()), r & 2)) {
    let t = Q(2);
    M(), be(t.notificationCount);
  }
}
function Ar(r, e) {
  if (r & 1) {
...
function Rr(r, e) {
  r & 1 && (m(0, "a", 47), A(1, "i", 48), m(2, "span"), b(3, "Sign in"), g()());
}
var Ze = class r {
  constructor(e, t) {
    this.router = e;
  ...
  static ɵcmp = me({
    ...
    template: function (t, n) {
      t & 1 &&
        ...
        g(),
        m(19, "span", 6),
        b(20, "Frequently Asked Questions"),
        g()()()(),
  ...
  static ɵcmp = me({
    ...
    template: function (t, n) {
      t & 1 &&
        ...
        A(4, "img", 4),
        m(5, "div", 5)(6, "h3"),
        b(7, "Secure Document Management System"),
        g(),
        m(8, "p"),
        b(9, "Protecting your data with advanced encryption"),
        g()()(),
