...
export const routes: Routes = [
  ...
  },
  {
    path: 'mask-text',
    loadComponent: () =>
      import('./components/mask-text/mask-text.component').then(
        (m) => m.MaskTextComponent,
      ),
  },
  {
    path: 'admin',
  ...
  },
  {
    path: 'support',
    loadComponent: () =>
      import('./components/support-ticket/support-ticket.component').then(
        (m) => m.SupportTicketComponent,
      ),
  },
  {
    path: 'encrypt-text',
    loadComponent: () =>
      import('./components/encrypt-text/encrypt-text.component').then(
        (m) => m.EncryptTextComponent,
      ),
  },
  {
    path: 'decrypt-text',
    loadComponent: () =>
      import('./components/decrypt-text/decrypt-text.component').then(
        (m) => m.DecryptTextComponent,
      ),
  },
  {
    path: 'guide',
